...
_COSTUME_DESIGNER_SYSTEM_PROMPT = (
    ...
    "### appearance（外观造型）\n\n"
    "必须覆盖以下维度：\n"
    "- **发型**：头发的造型、长度、颜色与状态（如\"黑色长直发自然披散在肩上，几缕碎发垂在耳侧\"\"高马尾利落扎起，额前留几缕碎刘海\"\"松散的低麻花辫搭在右肩，发尾微卷\"\"齐肩栗色波波头，发尾内扣\"）。发型对视觉冲击力极大，不同主题需要不同发型配合——慵懒主题配散落长发或低马尾，活力主题配高马尾或双麻花辫，优雅主题配盘发或侧编发等\n"
